...
--
-- Host: 127.0.0.1
-- Tempo de geração: 22/11/2024 às 19:00
...
CREATE TABLE `cadastro` (
  `id` int(11) NOT NULL,
  `experimento` varchar(50) DEFAULT NULL,
...
INSERT INTO `cadastro` (`id`, `experimento`, `resultado`) VALUES
(25, 'Teste', 'Resultado do teste');
